	...
	'fields' => array_merge(
		...
		array(
			...
			'h_typography_4' => array(
				...
				'description' => sprintf( __( 'Add custom fonts via uploading %s files.', 'us' ), '<strong>woff2</strong>' ) . ' <a target="_blank" href="' . $help_portal_url . '/' . strtolower( US_THEMENAME ) . '/typography/#uploaded-fonts">' . __( 'Learn more', 'us' ) . '</a>.',
				'type' => 'heading',
			),
