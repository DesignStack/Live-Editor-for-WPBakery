...
us_load_template( 'templates/us_grid/listing-start', $template_vars + $filled_atts );
...
// Load List End
us_load_template( 'templates/us_grid/listing-end', $template_vars + $filled_atts );
