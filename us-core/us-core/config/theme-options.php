	...
	'layout' => array(
		...
		'fields' => array(
			'layout_head_message' => array(
				'description' => '<a target="_blank" href="' . esc_url( $usb_edit_layout_link ) . '"><strong>' . __( 'Edit Live', 'us' ) . '</strong></a>',
				'type' => 'message',
		...
		'fields' => array_merge(
			array(
				...
				'product_gallery_aspect_ratio_custom' => array(
					'description' => __( 'Examples:', 'us' ) . ' <span class="usof-example">21/9</span>, <span class="usof-example">7/5</span>, <span class="usof-example">1.85/1</span>',
					'type' => 'text',
					'std' => '21/9',
					'classes' => 'for_above',
					'cols' => 2,
				...
				'product_gallery_empty_space' => array(
					'description' => '',
					'type' => 'message',
					'classes' => 'remove_padding', // this field is used only for aligning UI
				),
