...
$us.$document.on('keydown.usPopup',(e)=>{$us.WPopup.prototype.tabFocusTrap(e,$popup,$popupCloser,triggerElm)})}});$us.$document.on('usPopupClosed',()=>{$us.$document.off('keydown.usPopup')})}(jQuery)